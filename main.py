...
try:
    ...
    print(f"⚠ Warning: Model B not found. Disease detection will be disabled. {e}")
    model_b = None
    scaler_b = None
...
def health_check():
    return {
        ...
        "models_loaded": {
            "model_a": "✅ Loaded",
            "model_b": "✅ Loaded" if MODEL_B_AVAILABLE else "⚠ Not available (disease detection disabled)"
        },
        "twilio_configured": "✅ Configured" if client else "⚠ Not configured"
    }
